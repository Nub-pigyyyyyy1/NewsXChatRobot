...
def get_response(message):
    ...
    response_list = [
        ...
        Bot_Response(message, ['your', 'name'],
                     'I am a chatxnews Bot, nice to meet you!'),
        # Help
        ...
        Bot_Response(message, [
                     'nude', 'nudes', ], 'I just took a screenshot, and I\'m sending your photo to @kira_yoshikage_789 right now, you lil horny ass😏'),

        # When Querry
        Bot_Response(message, ['when', '?', 'query', 'question', 'inform',
                     'developer'], 'Inquire with the developer about this. @Kira_OwO4'),

        # When Querry 
        Bot_Response(message, ['lawde ke baal', 'teri mkc', 'jnl', 'lawde', 
                     'Madarchod'], 'Bsdk gand me danda daal dunga!! Ma bhi chod dunga'), 
